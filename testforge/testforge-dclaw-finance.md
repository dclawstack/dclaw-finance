# TestForge Report — /work/project/dclaw-finance

**Overall:** 70/100  ·  8000 files · 799,528 lines · 50 endpoints
**Stack:** FastAPI, SQLAlchemy, Pydantic, Alembic, pytest, HTTP client (httpx/requests), PostgreSQL, Uvicorn/Gunicorn
**Analyzed:** 2026-05-31T13:32:31.112Z
...
| N+1 Queries | 42/100 | 0 |
| Dead Code | 80/100 | 0 |
| Load | N/A | 0 |
| Chaos | 100/100 | 0 |
| Agentic Scale | 91/100 | 1 |
| Accessibility | 77/100 | 0 |
| Visual Regression | 93/100 | 0 |
| Vision | 81/100 | 3 |
| Scope | 100/100 | 0 |
| Stack | 39/100 | 0 |
| DORA | 25/100 | 0 |
...
| Metric | Value |
|---|---|
| Estimated function coverage | 66% |
| Test files | 42 |
| Test cases | 245 |
| Frameworks | pytest |
...
761 total · 452 critical · 305 high · 1 medium · 0 low
- **[HIGH]** XSS via `write()` helper — `web/node_modules/object-hash/index.js:221`
  - _Fix:_ Either sanitize the argument before passing it to `write`, or rewrite `write` to use the safe alternative (parameterized queries, escape, etc.) internally.
- **[HIGH]** XSS via `write()` helper — `web/node_modules/object-hash/index.js:245`
  - _Fix:_ Either sanitize the argument before passing it to `write`, or rewrite `write` to use the safe alternative (parameterized queries, escape, etc.) internally.
